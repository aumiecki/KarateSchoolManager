...
Partial Public Class karateDataSet
    ...
    Partial Public Class PaymentsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddPaymentsRow(ByVal Payment_Date As Date, ByVal Amount As Decimal, ByVal parentMembersRowByFK_Payments_Members As MembersRow) As PaymentsRow
            Dim rowPaymentsRow As PaymentsRow = CType(Me.NewRow,PaymentsRow)
            Dim columnValuesArray() As Object = New Object() {Payment_Date, Amount, Nothing, Nothing}
            If (Not (parentMembersRowByFK_Payments_Members) Is Nothing) Then
                columnValuesArray(3) = parentMembersRowByFK_Payments_Members(0)
            End If
    ...
    Partial Public Class MemberPaymentDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddMemberPaymentRow(ByVal Last_Name As String, ByVal First_Name As String, ByVal Payment_Date As Date, ByVal Amount As Decimal) As MemberPaymentRow
            Dim rowMemberPaymentRow As MemberPaymentRow = CType(Me.NewRow,MemberPaymentRow)
            Dim columnValuesArray() As Object = New Object() {Last_Name, First_Name, Payment_Date, Amount}
    ...
    Partial Public Class MemberPaymentRow
        ...
        Public Property Last_Name() As String
            Get
                Return CType(Me(Me.tableMemberPayment.Last_NameColumn),String)
            End Get
            Set
                Me(Me.tableMemberPayment.Last_NameColumn) = value
            End Set
        End Property
        ...
        Public Property First_Name() As String
            Get
                Return CType(Me(Me.tableMemberPayment.First_NameColumn),String)
            End Get
            Set
                Me(Me.tableMemberPayment.First_NameColumn) = value
            End Set
        End Property
        ...
        Public Property Payment_Date() As Date
            Get
                Return CType(Me(Me.tableMemberPayment.Payment_DateColumn),Date)
            End Get
            Set
                Me(Me.tableMemberPayment.Payment_DateColumn) = value
            End Set
        End Property
        ...
        Public Property Amount() As Decimal
            Get
                Return CType(Me(Me.tableMemberPayment.AmountColumn),Decimal)
            End Get
            Set
    ...
    Partial Public Class MemberPaymentTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Members.Last_Name, Members.First_Name, Payments.Payment_Date, Payments.Amo"& _ 
                "unt "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM Members INNER JOIN Payments ON Members.ID = Payments.Member_Id "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHER"& _ 
                "E (Members.Last_Name LIKE @name + '%')"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@name", Global.System.Data.SqlDbType.NVarChar, 30, Global.System.Data.ParameterDirection.Input, 0, 0, "Last_Name", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function FindPayment(ByVal dataTable As karateDataSet.MemberPaymentDataTable, ByVal name As String) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (name Is Nothing) Then
                Throw New Global.System.ArgumentNullException("name")
            Else
